...
rand_three <- read.table(("combined_data/random/sample_stats_3.txt"), header=TRUE, sep=",")
rand_five <- read.table(("combined_data/random/sample_stats_5.txt"), header=TRUE, sep=",")
rand_ten <- read.table(("combined_data/random/sample_stats_10.txt"), header=TRUE, sep=",")
rand_twenty <- read.table(("combined_data/random/sample_stats_20.txt"), header=TRUE, sep=",")
rand_thirty <- read.table(("combined_data/random/sample_stats_30.txt"), header=TRUE, sep=",")
rand_forty <- read.table(("combined_data/random/sample_stats_40.txt"), header=TRUE, sep=",")
rand_fifty <- read.table(("combined_data/random/sample_stats_50.txt"), header=TRUE, sep=",")
rand_sixty <- read.table(("combined_data/random/sample_stats_60.txt"), header=TRUE, sep=",")
rand_seventy <- read.table(("combined_data/random/sample_stats_70.txt"), header=TRUE, sep=",")
rand_eighty <- read.table(("combined_data/random/sample_stats_80.txt"), header=TRUE, sep=",")
rand_ninety <- read.table(("combined_data/random/sample_stats_90.txt"), header=TRUE, sep=",")
rand_hundred <- read.table(("combined_data/random/sample_stats_100.txt"), header=TRUE, sep=",")
...
############ MNIST
############
# pdf("../../figs/uniform_sample_exp/mnist/mnist_uniform_sample_exp.pdf")
# par(mar=c(5, 5, 5, 5))
...
pdf("../../figs/uniform_sample_exp/mpeg7/mpeg7_uniform_sample_exp.pdf")
par(mar=c(5, 5, 5, 5))
...
#### method 2 of removing influential points
...
#   xlab="Number of Vertices",
#   ylab="Hits over Number of Stratum",
#   # main="Random Data Uniform Sampling (16384 samples)",
#   family="serif",cex.lab=3, cex.main=2,
#   cex.sub=2,cex.axis=2)
